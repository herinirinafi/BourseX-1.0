        ...
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            <View style={{ flex: 1, flexDirection: 'column' }} >
                ...
                <View style={{ flex: 1, backgroundColor: '#fff', flexDirection: 'row', justifyContent: "flex-start", alignItems: 'center' }} >
                    ...
                    {/* header Text */}
                    <Text style={{ width: '90%', textAlign: 'center', fontFamily: 'Roboto-Bold', fontSize: 18, color: '#333' }} >Live Market</Text>
                </View>
                ...
                <View style={{ flex: 4, backgroundColor: '#fff', paddingHorizontal: '2%' }} >
                    ...
                    <FlatList
                        ...
                        data={dummyData.coins}
                        renderItem={({ item }) => (
                            <View style={{ flexDirection: 'row', height: hp('11%'), width: '100%', borderWidth: 1, borderColor: '#ddd', borderRadius: 15, justifyContent: 'space-between', paddingRight: 10, marginBottom: 15 }} >
